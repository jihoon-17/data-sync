...
public class MacData2MysqlConsume  implements consume{
    ...
    public void consume() {
        ...
        try {
            ...
            conn = JdbcUtil.getConnection(Constants.MYSQL_JDBCURL, Constants.MYSQL_USERNAME, Constants.MYSQL_PASSWORD);
            // 禁用自动提交
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, String> record : records) {
                    ...
                    preparedStatement = conn.prepareStatement(JdbcUtil.buildReplaceSql(tablename,fields));

                    log.info("upsert sql:{}",JdbcUtil.buildReplaceSql(tablename,fields));
...
//                            log.info("upsert field:{},value:{}",fields.get(j),value);
            ...
            log.info("mysqlConsume close,need restart app!!!");
        }
