...
import cn.com.daikin.writer.streamload.StringStreamLoad;
...
public class MacData2HanaConsume implements consume {
    ...
    public void consume() {
        ...
        try {
            ...
            // 连接池
            DataSource dataSource = DatabaseConfig.getDataSourceForHana(Constants.HANA_JDBCURL, Constants.HANA_USERNAME, Constants.HANA_PASSWORD);
            ...
            try (Connection conn = dataSource.getConnection()) {
                ...
                while (true) {
                    ...
                    for (ConsumerRecord<String, String> record : records) {
                        ...
                        try (PreparedStatement preparedStatement = conn.prepareStatement(JdbcUtil.buildUpsertSql(tablename, fields))) {
                            ...
                            for (int i = 0; i < jsonArray.size(); i++) {
                                ...
                                if (isdeleted.equals(Constants.TRUE)) {
                                    log.info("MacData2HanaConsume isdelete is true,id:{}", jsonObject.getStr("Id"));
                                    continue;
                                }
                            ...
                            log.error("MacData2HanaConsume preparedStatement error:", e);
                        }
                ...
                log.error("MacData2HanaConsume insert error:", e);
            }
